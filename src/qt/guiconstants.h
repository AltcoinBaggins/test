...
/* earnscoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Earnscoin"
#define QAPP_ORG_DOMAIN "earnscoin.trade"
#define QAPP_APP_NAME_DEFAULT "Earnscoin-Qt"
#define QAPP_APP_NAME_TESTNET "Earnscoin-Qt-testnet"
