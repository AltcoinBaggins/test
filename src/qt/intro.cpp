...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Earnscoin Core"),
     ...
     * override -datadir in the earnscoin.conf file in the default data directory
     * (to be consistent with earnscoind behavior)
     */
