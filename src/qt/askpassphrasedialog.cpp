...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            earnscoinGUI* window = static_cast<earnscoinGUI*>(parentWidget());
...
{
    earnscoinGUI* gui = static_cast<earnscoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<earnscoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Earnscoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your ERNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
