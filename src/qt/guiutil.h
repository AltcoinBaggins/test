...
/** Utility functions used by the earnscoin Qt UI.
 */
namespace GUIUtil
{
...
// Render earnscoin addresses in monospace font
...
// Parse "earnscoin:" URI into recipient object, return true on successful parsing
