...
#ifndef earnscoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define earnscoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //earnscoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
