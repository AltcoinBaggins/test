...
#include "qt/earnscoin/topbar.h"
#include "qt/earnscoin/forms/ui_topbar.h"
#include "qt/earnscoin/lockunlock.h"
#include "qt/earnscoin/qtutils.h"
#include "qt/earnscoin/receivedialog.h"
#include "qt/earnscoin/loadingdialog.h"
...
TopBar::TopBar(earnscoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopERN}, "amount-small-topbar");
    setCssProperty({ui->labelAmountERN}, "amount-topbar");
    setCssProperty({ui->labelPendingERN, ui->labelImmatureERN}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("earnscoin")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // ERN Total
    QString totalERN = GUIUtil::formatBalance(balance, nDisplayUnit);

    // ERN
    // Top
    ui->labelAmountTopERN->setText(totalERN);
    // Expanded
    ui->labelAmountERN->setText(totalERN);
    ui->labelPendingERN->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureERN->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
