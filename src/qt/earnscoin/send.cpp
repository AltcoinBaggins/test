...
#include "qt/earnscoin/forms/ui_send.h"
#include "qt/earnscoin/addnewcontactdialog.h"
#include "qt/earnscoin/qtutils.h"
#include "qt/earnscoin/sendchangeaddressdialog.h"
#include "qt/earnscoin/optionbutton.h"
#include "qt/earnscoin/sendconfirmdialog.h"
#include "qt/earnscoin/myaddressrow.h"
#include "qt/earnscoin/guitransactionsutils.h"
...
SendWidget::SendWidget(earnscoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-earnscoin");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination earnscoinAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(earnscoinAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(earnscoinAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
