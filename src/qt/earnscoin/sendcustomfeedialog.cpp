...
#include "qt/earnscoin/sendcustomfeedialog.h"
#include "qt/earnscoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(earnscoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &earnscoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
