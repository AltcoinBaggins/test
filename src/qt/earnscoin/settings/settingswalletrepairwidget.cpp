...
#include "qt/earnscoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/earnscoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(earnscoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to earnscoinGUI::handleRestart()
