...
#include "qt/earnscoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(earnscoinGUI* _window, QWidget *parent) :
