...
#include "qt/earnscoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(earnscoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &earnscoinGUI::openFAQ);
