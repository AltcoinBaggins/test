...
#include "qt/earnscoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/earnscoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(earnscoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Earnscoin RPC console.") + "<br>" +
