...
#include "qt/earnscoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/earnscoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(earnscoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableERN,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableERN,
    ...
    connect(ui->pushButton_UnspendableERN, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableERN);});
    ...
    if (parent)
        connect(parent, &earnscoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
