...
#include "qt/earnscoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/earnscoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(earnscoinGUI* _window, QWidget *parent) :
