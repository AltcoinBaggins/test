...
#include "qt/earnscoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(earnscoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("earnscoin_tx_csv_export(*.csv)") : tr("earnscoin_addresses_csv_export(*.csv)"),
                                        nullptr);
