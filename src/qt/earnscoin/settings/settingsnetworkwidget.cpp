...
#include "qt/earnscoin/settings/settingsnetworkwidget.h"
#include "qt/earnscoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/earnscoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(earnscoinGUI* _window, QWidget *parent) :
