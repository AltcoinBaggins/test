...
#include "qt/earnscoin/forms/ui_addresseswidget.h"
#include "qt/earnscoin/addresslabelrow.h"
#include "qt/earnscoin/addnewaddressdialog.h"
#include "qt/earnscoin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(earnscoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination earnscoinAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(earnscoinAdd, label.toUtf8().constData(),
