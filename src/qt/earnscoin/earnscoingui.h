...
#ifndef earnscoin_CORE_NEW_GUI_earnscoinGUI_H
#define earnscoin_CORE_NEW_GUI_earnscoinGUI_H
...
#include "qt/earnscoin/navmenuwidget.h"
#include "qt/earnscoin/topbar.h"
#include "qt/earnscoin/dashboardwidget.h"
#include "qt/earnscoin/send.h"
#include "qt/earnscoin/receivewidget.h"
#include "qt/earnscoin/addresseswidget.h"
#include "qt/earnscoin/coldstakingwidget.h"
#include "qt/earnscoin/masternodeswidget.h"
#include "qt/earnscoin/snackbar.h"
#include "qt/earnscoin/settings/settingswidget.h"
...
/**
  earnscoin GUI main class. This class represents the main window of the earnscoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class earnscoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit earnscoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~earnscoinGUI();
...
#endif //earnscoin_CORE_NEW_GUI_earnscoinGUI_H
