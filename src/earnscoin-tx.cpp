...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("earnscoin earnscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  earnscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded earnscoin transaction") + "\n" +
                               "  earnscoin-tx [options] -create [commands]   " + _("Create hex-encoded earnscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded earnscoin transaction
