...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Earnscoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Earnscoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* earnscoin features */
        {"earnscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"earnscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"earnscoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"earnscoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"earnscoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"earnscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"earnscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"earnscoin", "startmasternode", &startmasternode, true, true, false},
        {"earnscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"earnscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"earnscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"earnscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"earnscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"earnscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"earnscoin", "preparebudget", &preparebudget, true, true, false},
        {"earnscoin", "submitbudget", &submitbudget, true, true, false},
        {"earnscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"earnscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"earnscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"earnscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"earnscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"earnscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"earnscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"earnscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"earnscoin", "mnsync", &mnsync, true, true, false},
        {"earnscoin", "spork", &spork, true, true, false},
...
{
    return "> earnscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6663/\n";
}
