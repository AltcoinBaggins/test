...
The build script we'll be using is contained in the earnscoin github repository ([contrib/gitian-build.py](https://github.com/earnscoinvps-project/earnscoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the earnscoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/earnscoinvps-project/earnscoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, earnscoin-detached-sigs, and earnscoin GitHub repos.
