...
The script [extract-osx-sdk.sh](https://github.com/earnscoinvps-project/earnscoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
earnscoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/earnscoinvps-project/earnscoin/blob/master/doc/README_osx.md) for troubleshooting tips.
