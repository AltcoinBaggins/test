Contributing to earnscoin
============================

The earnscoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/earnscoinvps-project/earnscoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the earnscoin project, and is not to be
confused with overall earnscoin Network Protocol consensus changes.

Whether a pull request is merged into earnscoin rests with the project merge
...
Patches that change earnscoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the earnscoin consensus, it must have been
...
The project leader is the release manager for each earnscoin release.
