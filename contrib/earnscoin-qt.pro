...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/earnscoin-cli.cpp \
           src/earnscoin-tx.cpp \
           src/earnscoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/earnscoin.qrc src/qt/earnscoin_locale.qrc

TRANSLATIONS += src/qt/locale/earnscoin_bg.ts \
                src/qt/locale/earnscoin_de.ts \
                src/qt/locale/earnscoin_en.ts \
                src/qt/locale/earnscoin_es.ts \
                src/qt/locale/earnscoin_fi.ts \
                src/qt/locale/earnscoin_fr.ts \
                src/qt/locale/earnscoin_it.ts \
                src/qt/locale/earnscoin_ja.ts \
                src/qt/locale/earnscoin_pl.ts \
                src/qt/locale/earnscoin_pt.ts \
                src/qt/locale/earnscoin_ru.ts \
                src/qt/locale/earnscoin_sk.ts \
                src/qt/locale/earnscoin_sv.ts \
                src/qt/locale/earnscoin_vi.ts \
                src/qt/locale/earnscoin_zh_CN.ts \
                src/qt/locale/earnscoin_zh_TW.ts
